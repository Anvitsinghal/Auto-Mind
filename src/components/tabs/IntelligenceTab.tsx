  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center gap-3 animate-fade-in-up">
        ...
        <div>
          <h2 className="text-xl font-bold text-foreground">AutoMind Intelligence</h2>
          <p className="text-sm text-muted-foreground">AI-powered predictive analytics for your vehicle</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Driver DNA Panel */}
        <div className="glass-panel-elevated p-6 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              <Zap className="h-5 w-5 text-primary" />
              <h3 className="font-semibold text-foreground">Driver DNA Profile</h3>
            </div>
            <span className="text-xs px-2 py-1 rounded-full bg-primary/20 text-primary">Updated Today</span>
          </div>

          <div className="flex justify-center mb-6">
            <RadarChart data={driverDnaData} size={300} />
          </div>
          ...
          <div className="p-4 rounded-lg bg-secondary/30 border border-border/50">
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-sm text-foreground font-medium">Your Driving Style</p>
                <p className="text-xs text-muted-foreground mt-1">
                  Your profile indicates conservative driving with moderate terrain exposure. 
                  Braking intensity is slightly elevated—consider smoother deceleration to extend brake life.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="glass-panel p-6 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-foreground">Predictive Risk Assessment</h3>
            </div>
          ...
          <div className="glass-panel p-6 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
            ...
            <div className="mt-4 p-3 rounded-lg bg-success/10 border border-success/30 flex items-center gap-2">
              ...
              <span className="text-sm text-success">Your vehicle ranks in the top 15% of peers</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="animate-fade-in-up" style={{ animationDelay: '400ms' }}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-semibold text-foreground">Component Failure Predictions</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {failurePredictions.map((pred, i) => (
            <div 
              key={i} 
              className={`glass-panel p-5 border-l-4 animate-slide-in-right ${
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <h4 className="font-medium text-foreground">{pred.component}</h4>
